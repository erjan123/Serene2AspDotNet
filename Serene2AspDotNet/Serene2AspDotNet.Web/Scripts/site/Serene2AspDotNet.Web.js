var Serene2AspDotNet;
(function (Serene2AspDotNet) {
    var Administration;
    ...
    })(Administration = Serene2AspDotNet.Administration || (Serene2AspDotNet.Administration = {}));
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
var Serene2AspDotNet;
(function (Serene2AspDotNet) {
    var Administration;
    (function (Administration) {
...
(function (Serene2AspDotNet) {
    ...
    })(BasicSamples = Serene2AspDotNet.BasicSamples || (Serene2AspDotNet.BasicSamples = {}));
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
var Serene2AspDotNet;
(function (Serene2AspDotNet) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Serene2AspDotNet.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = Serene2AspDotNet.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Serene2AspDotNet.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (Serene2AspDotNet) {
    ...
    })(Common = Serene2AspDotNet.Common || (Serene2AspDotNet.Common = {}));
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
var Serene2AspDotNet;
(function (Serene2AspDotNet) {
    var Common;
...
(function (Serene2AspDotNet) {
    ...
    })(Membership = Serene2AspDotNet.Membership || (Serene2AspDotNet.Membership = {}));
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
var Serene2AspDotNet;
(function (Serene2AspDotNet) {
    var Membership;
...
(function (Serene2AspDotNet) {
    ...
    })(Northwind = Serene2AspDotNet.Northwind || (Serene2AspDotNet.Northwind = {}));
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
var Serene2AspDotNet;
(function (Serene2AspDotNet) {
    var Northwind;
...
(function (Serene2AspDotNet) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'Serene2AspDotNet.Northwind.Gender', 'Serene2AspDotNet.Northwind.Entities.Gender');
    })(Northwind = Serene2AspDotNet.Northwind || (Serene2AspDotNet.Northwind = {}));
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
var Serene2AspDotNet;
(function (Serene2AspDotNet) {
...
(function (Serene2AspDotNet) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Serene2AspDotNet.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Serene2AspDotNet.LanguageList || (Serene2AspDotNet.LanguageList = {}));
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
...
(function (Serene2AspDotNet) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('Serene2AspDotNet');
        Serenity.EntityDialog.defaultLanguageList = Serene2AspDotNet.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = Serene2AspDotNet.ScriptInitialization || (Serene2AspDotNet.ScriptInitialization = {}));
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
var Serene2AspDotNet;
(function (Serene2AspDotNet) {
    var Administration;
...
(function (Serene2AspDotNet) {
    ...
    Serene2AspDotNet.BasicProgressDialog = BasicProgressDialog;
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
var Serene2AspDotNet;
(function (Serene2AspDotNet) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Serene2AspDotNet.BasicProgressDialog();
...
(function (Serene2AspDotNet) {
    ...
    })(DialogUtils = Serene2AspDotNet.DialogUtils || (Serene2AspDotNet.DialogUtils = {}));
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
var Serene2AspDotNet;
(function (Serene2AspDotNet) {
    var Common;
...
(function (Serene2AspDotNet) {
    ...
    Serene2AspDotNet.StaticTextBlock = StaticTextBlock;
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
var Serene2AspDotNet;
(function (Serene2AspDotNet) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Serene2AspDotNet.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(Serene2AspDotNet.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(Serene2AspDotNet.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Serene2AspDotNet.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Serene2AspDotNet.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Serene2AspDotNet.Authorization.userDefinition.DisplayName,
...
(function (Serene2AspDotNet) {
    ...
    (function (Northwind) {
        ...
        }(Serene2AspDotNet.Common.GridEditorDialog));
...
(function (Serene2AspDotNet) {
    ...
    (function (Northwind) {
        ...
        }(Serene2AspDotNet.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return Serene2AspDotNet.LanguageList.getValue();
            };
...
(function (Serene2AspDotNet) {
    ...
    })(Authorization = Serene2AspDotNet.Authorization || (Serene2AspDotNet.Authorization = {}));
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
var Serene2AspDotNet;
(function (Serene2AspDotNet) {
    var BasicSamples;
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene2AspDotNet.Northwind.ProductDialog));
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene2AspDotNet.Northwind.ProductGrid));
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Serene2AspDotNet.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Serene2AspDotNet.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Serene2AspDotNet.Northwind.OrderDialog();
                        ...
                        var chai = Serene2AspDotNet.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Serene2AspDotNet.Northwind.EmployeeRow.getLookup().items
        ...
        }(Serene2AspDotNet.Northwind.OrderGrid));
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene2AspDotNet.Northwind.OrderDialog));
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Serene2AspDotNet.Northwind.CategoryService.Retrieve({
        ...
        }(Serene2AspDotNet.Northwind.CategoryDialog));
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene2AspDotNet.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(Serene2AspDotNet.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Serene2AspDotNet.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Serene2AspDotNet.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Serene2AspDotNet.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    Serene2AspDotNet.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Serene2AspDotNet.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Serene2AspDotNet.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Serene2AspDotNet.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Serene2AspDotNet.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Serene2AspDotNet.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Serene2AspDotNet.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Serene2AspDotNet.Northwind.OrderService.baseUrl; };
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene2AspDotNet.Northwind.SupplierDialog));
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(Serene2AspDotNet.Northwind.SupplierGrid));
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Serene2AspDotNet.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Serene2AspDotNet.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Serene2AspDotNet.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Serene2AspDotNet.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Serene2AspDotNet.Northwind.OrderService.baseUrl; };
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Serene2AspDotNet.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Serene2AspDotNet.Northwind.CustomerDialog));
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene2AspDotNet.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = Serene2AspDotNet.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Serene2AspDotNet.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Serene2AspDotNet.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Serene2AspDotNet.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(Serene2AspDotNet.Northwind.OrderDetailDialog));
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene2AspDotNet.Northwind.OrderDetailsEditor));
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Serene2AspDotNet.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Serene2AspDotNet.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Serene2AspDotNet.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Serene2AspDotNet.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Serene2AspDotNet.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        ...
        }(Serene2AspDotNet.Common.BulkServiceAction));
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Serene2AspDotNet.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Serene2AspDotNet.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Serene2AspDotNet.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Serene2AspDotNet.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Serene2AspDotNet.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Serene2AspDotNet.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Serene2AspDotNet.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Serene2AspDotNet.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (Serene2AspDotNet) {
    ...
    Serene2AspDotNet.SelectableEntityGrid = SelectableEntityGrid;
})(Serene2AspDotNet || (Serene2AspDotNet = {}));
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Serene2AspDotNet.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Serene2AspDotNet.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Serene2AspDotNet.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Serene2AspDotNet.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Serene2AspDotNet.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = Serene2AspDotNet.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Serene2AspDotNet.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Serene2AspDotNet.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Serene2AspDotNet.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Serene2AspDotNet.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Serene2AspDotNet.Northwind.ProductService.baseUrl; };
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Serene2AspDotNet.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Serene2AspDotNet.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Serene2AspDotNet.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Serene2AspDotNet.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Serene2AspDotNet.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Serene2AspDotNet.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Serene2AspDotNet) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Serene2AspDotNet.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Serene2AspDotNet.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Serene2AspDotNet.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=Serene2AspDotNet.Web.js.map